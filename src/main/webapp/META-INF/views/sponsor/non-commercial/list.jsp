...
<acme:list>
    ...
    <acme:list-column code="sponsor.non-commercial.list.label.url" path="url" width="40%"/>     
    <acme:list-column code="sponsor.non-commercial.list.label.jingle" path="jingle" width="40%"/>      
